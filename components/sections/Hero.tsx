        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 items-center">
          ...
          <div className="text-center md:text-left">
            <div className="flex justify-center md:justify-start">
              <KickerPill>Now supporting Claude, GPT-4 &amp; Gemini</KickerPill>
            </div>
            ...
            <p className="font-sans text-[1rem] md:text-[1.05rem] text-text-muted leading-[1.68] mb-10 max-w-[460px] mx-auto md:mx-0">
            ...
            <div className="flex items-center gap-6 md:gap-8 justify-center md:justify-start">
              <div>
                ...
                <div className="font-mono text-[0.62rem] text-text-muted mt-0.5 tracking-[0.04em]">avg token reduction</div>
              </div>
              <div className="w-px h-9 bg-border" />
              <div>
                <div className="font-grotesk font-bold text-[1.4rem] md:text-[1.6rem] tracking-tight">3 models</div>
                <div className="font-mono text-[0.62rem] text-text-muted mt-0.5">Claude · GPT · Gemini</div>
              </div>
              <div className="w-px h-9 bg-border" />
              <div>
    ...
    <div className="bg-bg-card border border-border rounded-4xl overflow-hidden shadow-hero-card relative top-gradient-border">
      ...
      <div className="p-4 md:p-5 space-y-3.5">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="font-mono text-[0.62rem] text-text-muted">saved ~$0.0002</span>
        </div>
      </div>
    </div>
  )
